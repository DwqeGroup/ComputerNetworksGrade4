...
if __name__ == "__main__":
    my_ftp = MyFTP("192.168.43.66")
    my_ftp.login("123", "123")

    # 下载单个文件
    #my_ftp.download_file("C:\Users\tc\Downloads", "/test.txt")
    my_ftp.download_file("C:/Users/tc/Downloads/test.txt", "/test.txt")

    # 下载目录
    # my_ftp.download_file_tree("G:/ftp_test/", "App/AutoUpload/ouyangpeng/I12/")

    # 上传单个文件
    #my_ftp.upload_file("C:\Users\tc\Downloads\upload_test.txt", "/")
    my_ftp.upload_file("C:/Users/tc/Downloads/upload_test.txt", "/upload_test.txt")
